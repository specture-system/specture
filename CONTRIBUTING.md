...
5. Grant the app `Contents: Read and write` and `Pull requests: Read and write`.
   - [GitHub App permissions](https://docs.github.com/en/apps/creating-github-apps/registering-a-github-app#setting-permissions-for-github-apps)
...
8. Save the app's client ID as the repository secret `RELEASE_BOT_CLIENT_ID`.
