...
4. Open {{.ContributionType}}s to share and refine the spec with the team
...
1. Once the team agrees the spec is ready for implementation, update status to `approved` in a {{.ContributionType}}
2. Merge the {{.ContributionType}} with the updated status
