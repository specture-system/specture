...
When referencing another spec, always use an inline markdown link with the correct repo-root-relative path to that file (for example, `[Status command](specs/status-command/SPEC.md)`).
